...
SAMPLE_RESULT = {
    ...
    "ats":           {"ats_score": 45, "matched_keywords": ["python"],
                      "missing_keywords": ["fastapi", "docker", "tensorflow"]},
    "match":         {"match_percentage": 52.3,
                      "verdict": "Moderate match - improve resume"},
    "skill_gap":     {"missing_skills": ["fastapi", "docker", "tensorflow"],
                      "present_skills": ["python", "machine learning"]},
